...
<ul class = "navig1">
  ...
  <li class="navig h" style="border-bottom: 0.5px solid #E88C08;"><a href="{{ route('register') }}">Sign Up</a></li>
...
<br>
<br>
<p class="signUphr">SignUp</p>
    <form action="{{ route('register') }}" method="POST">
        {{ csrf_field() }}
         
        <input type="text" placeholder=" Name" name="name" value="{{ old('name') }}" class = "loginPass loginPass1" required autofocus>
        @if ($errors->has('name'))
        ...
        @endif
        <input type="password" placeholder="Confirm Password" name="password_confirmation" class = "loginPass loginPass1">
